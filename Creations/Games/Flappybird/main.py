...
bg_surface = pygame.image.load("https://github.com/princebhatt9588/Versatile_Code_Hub/raw/main/assets/background-night.png")
floor_surface = pygame.image.load("https://github.com/princebhatt9588/Versatile_Code_Hub/raw/main/assets/base.png")
floor_x_pos = 0

bird_downflap = pygame.image.load("https://github.com/princebhatt9588/Versatile_Code_Hub/raw/main/assets/bluebird.png").convert_alpha()
bird_midflap = pygame.image.load("https://github.com/princebhatt9588/Versatile_Code_Hub/raw/main/assets/bluebird-midflap.png").convert_alpha()
bird_upflap = pygame.image.load("https://github.com/princebhatt9588/Versatile_Code_Hub/raw/main/assets/bluebird-upflap.png").convert_alpha()
...
pipe_surface = pygame.image.load("https://github.com/princebhatt9588/Versatile_Code_Hub/raw/main/assets/pipe-green.png")
pipe_list = []
SPAWNPIPE = pygame.USEREVENT
pygame.time.set_timer(SPAWNPIPE, 1000)
pipe_height = [200, 250, 300, 350, 400]

game_over_surface = pygame.image.load("https://github.com/princebhatt9588/Versatile_Code_Hub/raw/main/assets/message.png")
